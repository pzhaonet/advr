...
# path_raw <- paste0(wd, '/advection_MB/data_raw/adv/CR1000_AdvData_2015_MB.dat')
# path_raw_header <- paste0(wd, '/advection_MB/data_raw/adv/header.csv')
...
#'
#' @examples
plotraw_cut <- function(aa, sub_by = 1, suffix = 'daily'){
  if(is.na(sub_by)) {
  ...
  ###### settings
  colname_t[!colname_t %in% names(aa)]
